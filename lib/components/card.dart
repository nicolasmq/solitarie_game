...
import 'package:solitarie_game/rank.dart';
import 'package:solitarie_game/solitarie_game.dart';
import 'package:solitarie_game/suit.dart';
...
class Card extends PositionComponent {
  Card(int intRank, int intSuit)
      : rank = Rank.of(intRank),
        ...
        _faceUp = false,
        super(size: SolitarieGame.cardSize);
  ...
  // this are the variables for the back of the card
  ...
  static final RRect cardRRect = RRect.fromRectAndRadius(
    SolitarieGame.cardSize.toRect(),
    const Radius.circular(SolitarieGame.cardRadius),
  );
  static final RRect backRRectInner = cardRRect.deflate(40);
  static late final Sprite flameSprite = solitarieSprite(1367, 6, 357, 501);

  // these are variables for the front o the card
  ...
  static late final Sprite redJack = solitarieSprite(81, 565, 562, 488);
  static late final Sprite redQueen = solitarieSprite(717, 541, 486, 515);
  static late final Sprite redKing = solitarieSprite(1305, 532, 407, 549);
  ...
  static late final Sprite blackJack = solitarieSprite(81, 565, 562, 488)
    ..paint = blueFilter;
  static late final Sprite blackQueen = solitarieSprite(717, 541, 486, 515)
    ..paint = blueFilter;
  static late final Sprite blackKing = solitarieSprite(1305, 532, 407, 549)
    ..paint = blueFilter;
